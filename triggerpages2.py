...
def makeNewPage(outfilename,trigger_id,event_paramfile):
	...
	html = 	'<!DOCTYPE HTML>\
		<html lang="en">\
	        ...
	        <div class="menu-area">\
                            <li>\
                                <a href="#header" class="smoothScroll">Trigger</a>\
                            </li>\
	                ...
	                <!-- Header -->\
	                        <header id="header">\
	                                <div class="content">\
	                                        ...
	                                        <p>Type: '+str(event_params['boc'])+'<br />\
	                                        <p><ul class="actions">\
												<li><a href="'+str(trigger_id)+'_JSON.zip" download class="button special icon fa-download">.json</a></li>\
											</ul><br />\
									</div>\
						...
						<div class="table-wrapper">\
							<table class="alt">\
								<tbody>\
									...
									<tr>\
										<td></td>\
										<td><b><u>LIGO Trigger Info</u></b></td>\
										<td></td>\
									</tr>\
									<tr>\
										<td>FAR</td>\
									...
									<tr>\
										<td></td>\
										<td><b><u>Processing Parameters</u></b> </td>\
										<td></td>\
									</tr>\
									<tr>\
										<td>nHexes</td>\

...
def process_gcn(payload, root):
    ...
    skymap_nickname = skymap_filename.split('.fits')[0]
    print skymap_nickname*100
    ...
    deepoutfolder = outfolder+'/'+skymap_nickname+'/'
    if not os.path.exists(deepoutfolder):
        os.makedirs(deepoutfolder)
    os.chmod(deepoutfolder, 0o777)

...
#
    ...
    def make_cumulative_probs(self):
        print ['python','./sims_study/cumulative_plots.py','-d','/data/des41.a/data/desgw/maininjector/sims_study/data','-p',self.outfolder,'-e',self.trigger_id,'-f',os.path.join(self.outfolder,'maps',self.trigger_id+'-ra-dec-prob-mjd-slot.txt')]
        subprocess.call(['python','./sims_study/cumulative_plots.py','-d','/data/des41.a/data/desgw/maininjector/sims_study/data','-p',self.outfolder,'-e',self.trigger_id,'-f',os.path.join(self.outfolder,'maps',self.trigger_id+'-ra-dec-prob-mjd-slot.txt')])
        os.system('scp '+os.path.join(self.outfolder,self.trigger_id+'-and-sim-cumprobs.png')+' ./DES_GW_Website/Triggers/'+self.trigger_id+'/images/')
